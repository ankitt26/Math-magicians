...
const Home = () => (
  <div className={styles.home}>
    ...
    <p className={styles.p2}>
      ...
      range of math problems presented in a visually appealing format. Users can
      input their answers directly into the application and receive instant
      feedback on their performance.
      {' '}
      <br />
      Math Magician typically offers different difficulty levels to cater to
      users of varying skill levels, from beginners to advanced learners. It may
